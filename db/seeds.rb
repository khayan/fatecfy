...
teste2 = User.create(name: "Victor Ferraz", email: "victorferraz@hotmail.com", password: "654321", password_confirmation: "654321")
teste2.favorites.create(favoritable: trinity)
teste2.recently_heards.create(album: the_great_bear)
teste2.recently_heards.create(album: paw_paw_tree)
teste2.recently_heards.create(album: aldebaran)